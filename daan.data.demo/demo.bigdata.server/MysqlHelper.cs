...
namespace Helpers
{
    ...
    public sealed partial class MySqlHelper
    {
        ...
        public int BulkInsertByFile(string filePath, DataTable tableSchema)
        {
            return BulkInsert(ConnectionString, filePath, tableSchema);
        }

        public static int BulkInsert(string connectionString, string filePath, DataTable tableSchema)
        {
            int insertCount = 0;
            ...
            using (var conn = new MySqlConnection(connectionString))
            {
                ...
                bl.Columns.AddRange(tableSchema.Columns.Cast<DataColumn>().Select(colum => colum.ColumnName));
